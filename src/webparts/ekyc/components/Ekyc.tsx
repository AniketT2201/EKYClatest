...
import type { IEkycProps } from './IEkycProps';
...
export default class Ekyc extends React.Component<IEkycProps> {
  public render(): React.ReactElement<IEkycProps> {
    const {
      currentSPContext,
      description,
      isDarkTheme,
    ...
    return (
      <section className={`${styles.ekyc} ${hasTeamsContext ? styles.teams : ''}`}>
        <ParallaxProvider>
          <HashRouter>

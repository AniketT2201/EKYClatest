...
export interface IDashboardOps {
    getDashboardData(props: IEkycProps): Promise<IEKYC[]>;
  ...
  getDashboardItemById(listName: string ,id: number, props: IEkycProps): Promise<IEKYC>;
  insertDashboardData(item: IEKYC, props: IEkycProps): Promise<any>;
  updateDashboardData(id: number, item: IEKYC, props: IEkycProps): Promise<void>;
  preFillData(code: string, props: IEkycProps): Promise<{EmployeeName?: string; Department?: string}>;
...
export default function DashboardOps(): IDashboardOps {
    ...
    const getDashboardData = async ( props: IEkycProps): Promise<IEKYC[]> => {
    ...
    const getDashboardItemById = async (listName: string ,id: number, props: IEkycProps): Promise<IEKYC> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const preFillData = async (code: string, props: IEkycProps): Promise<{EmployeeName?: string; Department?: string}> => {
        try {
    ...
    const insertDashboardData = async (item: IEKYC, props: IEkycProps): Promise<any> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const updateDashboardData = async (id: number, item: IEKYC, props: IEkycProps): Promise<void> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
